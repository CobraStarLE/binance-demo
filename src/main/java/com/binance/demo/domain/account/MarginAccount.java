...
public class MarginAccount {
  ...
  private List<com.binance.api.client.domain.account.MarginAssetBalance> userAssets;
  ...
  public List<com.binance.api.client.domain.account.MarginAssetBalance> getUserAssets() {
    return userAssets;
  }

  public void setUserAssets(List<com.binance.api.client.domain.account.MarginAssetBalance> userAssets) {
   ...
   */
  public com.binance.api.client.domain.account.MarginAssetBalance getAssetBalance(final String symbol) {

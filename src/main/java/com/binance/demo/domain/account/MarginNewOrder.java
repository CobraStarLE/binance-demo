...
public class MarginNewOrder {
     ...
     */
    private com.binance.api.client.domain.account.NewOrderResponseType newOrderRespType;
    ...
    public MarginNewOrder(String symbol, OrderSide side, OrderType type, TimeInForce timeInForce, String quantity) {
        ...
        this.newOrderRespType = com.binance.api.client.domain.account.NewOrderResponseType.RESULT;
    ...
    public com.binance.api.client.domain.account.NewOrderResponseType getNewOrderRespType() {

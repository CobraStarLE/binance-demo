...
import com.binance.api.client.domain.account.SwapStatus;
...
public class SwapHistory {
    ...
    private com.binance.api.client.domain.account.SwapStatus status;
    ...
    public com.binance.api.client.domain.account.SwapStatus getStatus() {
        return status;
    }

...
import com.binance.api.client.domain.account.Repay;
...
public class RepayQueryResult {
  ...
  private int total;
  private List<com.binance.api.client.domain.account.Repay> rows;
  ...
  public List<com.binance.api.client.domain.account.Repay> getRows() {
    return rows;
  }

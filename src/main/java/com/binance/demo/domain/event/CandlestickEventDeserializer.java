 ...
 *
 * @see com.binance.api.client.domain.event.CandlestickEvent
 */
public class CandlestickEventDeserializer extends JsonDeserializer<com.binance.api.client.domain.event.CandlestickEvent> {

  @Override
  public com.binance.api.client.domain.event.CandlestickEvent deserialize(JsonParser jp, DeserializationContext ctx) throws IOException {
    ObjectCodec oc = jp.getCodec();
    JsonNode node = oc.readTree(jp);

    com.binance.api.client.domain.event.CandlestickEvent candlestickEvent = new CandlestickEvent();

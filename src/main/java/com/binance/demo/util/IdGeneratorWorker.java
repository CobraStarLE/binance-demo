 ...
 */
@Slf4j
@Component("idGeneratorWorker")
public class IdGeneratorWorker {
    // 时间起始标记点，作为基准，一般取系统的最近时间（一旦确定不能变动）
    private final static long twepoch = 1551073994107L;
    // 机器标识位数
     ...
     */
    public IdGeneratorWorker(long workerId, long datacenterId) {
    ...
    public void init() {
        try {
            ...
            log.info("当前机器的workerId获取失败", ExceptionUtils.getStackTrace(e));
    ...
    protected static long getDatacenterId(long maxDatacenterId) {
        ...
        try {
            ...
            if (network == null) {
                ...
                byte[] mac = NetUtil.getLocalMacAddress().getBytes(StandardCharsets.UTF_8);
